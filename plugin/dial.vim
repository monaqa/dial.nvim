...
nnoremap <silent><expr> <Plug>(dial-increment) '<Cmd>lua require"dial".cmd.increment(' .. v:count1 .. ')<CR>'
nnoremap <silent><expr> <Plug>(dial-decrement) '<Cmd>lua require"dial".cmd.increment(' .. -v:count1 .. ')<CR>'
...
command! -range -nargs=1 DialIncrement lua require"dial".cmd.increment_command_with_range(1, {<f-args>}, {<line1>, <line2>})
command! -range -nargs=1 DialDecrement lua require"dial".cmd.increment_command_with_range(-1, {<f-args>}, {<line1>, <line2>})
