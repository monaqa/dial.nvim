...
describe("Test of ordinal.alias.en:", function()
    local augend = ordinal.alias.en
    ...
    describe("find function", function()
        it("can find ordinals", function()
            ...
            assert.are.same(augend:find("-2nd", 1), { from = 2, to = 4 })
            assert.are.same(augend:find("-3rd", 1), { from = 2, to = 4 })
            ...
            assert.are.same(augend:find("-22nd", 1), { from = 2, to = 5 })
            assert.are.same(augend:find("-23rd", 1), { from = 2, to = 5 })
            ...
            assert.are.same(augend:find("manifest-2nd.txt", 1), { from = 10, to = 12 })
    ...
    describe("add function", function()
        it("can increment ordinal", function()
            ...
            assert.are.same(augend:add("23rd", -1, 1), { text = "22nd", cursor = 1 })
            assert.are.same(augend:add("22nd", -1, 1), { text = "21st", cursor = 1 })
...
describe("Test of ordinal.alias.en_neg:", function()
    local augend = ordinal.alias.en_neg
